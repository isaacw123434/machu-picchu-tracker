...
def run(continuous=False, interval=10):
    ...
    with sync_playwright() as p:
        ...
        # Container for scraped data in the current iteration
        scraped_data = []
        # Container for context data
        ...
        while True:
            ...
            try:
                ...
                if scraped_data:
                    ...
                    print("No data scraped in this iteration.")

            except Exception as e:
                print(f"Error during scrape iteration: {e}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Machu Picchu ticket availability.")
    parser.add_argument("--continuous", "-c", action="store_true", help="Run the scraper in continuous mode.")
    parser.add_argument("--interval", "-i", type=int, default=10, help="Interval between scrapes in seconds (default: 10).")
    args = parser.parse_args()

    run(continuous=args.continuous, interval=args.interval)
